...
const Nav = () => {
    return (
        <header className="bg-blue-darker py-6 px-4 shadow-lg leading-normal">
            <div className="container md:flex md:items-center md:justify-between mx-auto px-2">
                <div className="container">
                    ...
                    <h1 id="logoname" className="flex mb-4 text-blue-light text-3xl text-left align-middle mx-auto py-2 px-5">dev X-Tension</h1>
